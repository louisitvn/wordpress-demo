...
class Link extends Model
{
    ...
    public function clicks($user = null, $campaign = null)
    {
    ...
    public function lastClick($user = null, $campaign = null)
    {
        $query = $this->clicks($user, $campaign)->orderBy('created_at', 'desc')->first();
