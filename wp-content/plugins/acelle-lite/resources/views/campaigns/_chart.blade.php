    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="badge-row">
                <span class="badge badge-info bg-blue badge-big">{{ $campaign->clickedEmailsRate() }}%</span>
