                                    <div class="row">
										<div class="col-md-12">
											<ul class="nav nav-tabs nav-tabs-top page-second-nav">
												...
												<li rel0="SubscriberController" rel1="MailListController/wordpressImport" class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
														...
														<li rel0="MailListController/wordpressImport">
                                                            <a href="{{ action('MailListController@wordpressImport', $list->uid) }}">
